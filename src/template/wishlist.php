                        ...
                        for($j=0; $j<count($arr); $j++){
                            ...
                            <div class='itembox col-12 col-md-4 d-flex align-items-center justify-content-center px-3 py-2 mb-3'>
                                ...
                                <div class='d-flex align-items-start justify-content-start flex-column'>
                                    ...
                                    <a href='./product_detail.html' class='btn btn-sm btn-info info'>Book Info</a>
                                    <div class='btn-gp d-flex align-items-center justify-content-start mt-2'>
                                        <a href=' class='me-3 cart' id='addcart'><i class='bi bi-cart-fill btn btn-sm fs-5'></i></a>
                                        <a href=' class=' mt-1'><i class='bi bi-trash'></i></a>
                                    </div>
                                </div>
                            </div>
                            ";
